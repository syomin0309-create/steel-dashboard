...
def render_filter_bar(selections, total_rows, filtered_rows):
    ...
    .aegis-filter-panel {
        ...
        margin: 0 0 12px 0;
        overflow: hidden;
        animation: aegisFadeUp .38s ease both;
    }
    ...
    .aegis-filter-panel::before {
        ...
        animation: aegisPulse 3.2s ease-in-out infinite;
        pointer-events: none;
    }

    .aegis-filter-panel::after {
        content: "";
        position: absolute;
        inset: 0;
        width: 38%;
        background: linear-gradient(90deg, transparent, rgba(255,255,255,.48), transparent);
        animation: aegisShine 4.4s ease-in-out infinite;
        pointer-events: none;
    }
